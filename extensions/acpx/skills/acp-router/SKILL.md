...
- `claude -> bundled @agentclientprotocol/claude-agent-acp@0.69.0`
- `codex -> bundled @agentclientprotocol/codex-acp@1.4.0 through OpenClaw's isolated CODEX_HOME wrapper`
